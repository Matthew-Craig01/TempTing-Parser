...
-spec do_decode(
    binary(),
    fun((gleam@dynamic:dynamic_()) -> {ok, GJC} |
        {error, list(gleam@dynamic:decode_error())})
) -> {ok, GJC} | {error, decode_error()}.
...
-spec nullable(gleam@option:option(GJM), fun((GJM) -> json())) -> json().
...
-spec array(list(GJQ), fun((GJQ) -> json())) -> json().
